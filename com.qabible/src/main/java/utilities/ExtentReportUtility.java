...
public class ExtentReportUtility implements ITestListener 
{
	...
	public void configureReport() 
	{
		...
		// System details
		reports.setSystemInfo("PC Name", "Jinitha");
	...
	public void onStart(ITestContext context) 		//method which is executed first
	{
		configureReport();
	}

	public void onFinish(ITestContext context) 		//method which is execute at last
	{
		reports.flush();			//generates the final output file
	}
